# Generated by Django 5.2 on 2025-05-27 14:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meeting_times', models.JSONField(default=list, verbose_name='meeting times')),
                ('location', models.CharField(max_length=200, verbose_name='location')),
                ('max_members', models.PositiveIntegerField(default=10, verbose_name='max members')),
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='studypeer.subject')),
            ],
        ),
    ]
